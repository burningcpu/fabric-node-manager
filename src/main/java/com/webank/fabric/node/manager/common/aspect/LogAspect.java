 ...
 * the License.
 */
package com.webank.fabric.node.manager.common.aspect;
...
public class LogAspect {
    ...
    private final String POINT_CUT = "execution(public * com.webank.fabric.node.manager.api.*.*Controller.*(..))";
    ...
    public Object methodAround(ProceedingJoinPoint point) throws Throwable {
        ...
        logger.debug("startTime:{} methodName:{} args:{}", startTime, methodName, JSON.toJSONString(args));
        Object result = null;
        try {
